...
CREATE TABLE INGREDIENTS (id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT, name TEXT, userid integer FOREIGN KEY REFERENCES USERS(id)), quantity FLOAT, carboncost FLOAT) 